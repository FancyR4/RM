...
{
	graphic_data_struct_t grapic_data_struct[2];
	uint8_t Judge_client_custom_graphic_single_Data[30];
};

union Judge_Graphic_Client_Five_t
{
	graphic_data_struct_t grapic_data_struct[5];
	uint8_t Judge_client_custom_graphic_single_Data[75];
};

union Judge_Graphic_Client_Seven_t
{
	graphic_data_struct_t grapic_data_struct[7];
	uint8_t Judge_client_custom_graphic_single_Data[105];
};
...
//	Judge_client_custom_graphic_single_t Judge_client_custom_graphic_single;
//	Judge_client_custom_graphic_double_t Judge_client_custom_graphic_double;
//	Judge_client_custom_graphic_five_t Judge_client_custom_graphic_five;
//	Judge_client_custom_graphic_seven_t Judge_client_custom_graphic_seven;
//	Judge_client_custom_character_t Judge_client_custom_character;
